                ...
                {results.map((s) => (
                  ...
                  >
                    ...
                    {(s.poster_path || s.profile_path) ? (
                      <div className={`relative overflow-hidden rounded ${s.media_type === 'person' ? 'w-12 h-12' : 'w-12 h-16'}`}>
                        <img
                          src={`https://image.tmdb.org/t/p/w92${s.poster_path || s.profile_path}`}
                          alt={s.title || s.name}
                          className="absolute inset-0 w-full h-full object-cover"
                        />
                      </div>
                    ) : (
                      <div className={`bg-gray-700 rounded flex items-center justify-center ${s.media_type === 'person' ? 'w-12 h-12' : 'w-12 h-16'}`}>
                    ...
                    <div className="ml-3 flex-1">
                      ...
                      <div className="flex items-center mt-1 mb-1">
                        <span className={`
                          ...
                          ${s.media_type === 'movie' ? 'bg-blue-900 text-blue-200' : 
                            s.media_type === 'tv' ? 'bg-green-900 text-green-200' :
