...
export default function WatchlistPage() {
  ...
  const { watchlistItems, loading, error } = useAppSelector(state => state.userActions);
  ...
  return (
    <Layout>
      <div className="container mx-auto">
        ...
        {/* Error Message */}
        {error && (
          <div className="p-4 mb-4 text-red-500 bg-red-100/10 rounded">
            {error}
          </div>
        )}
        ...
        {loading ? (
          ...
          >
            ...
            <p className="mt-2 text-sm">
              Start adding movies by clicking the bookmark icon on any movie card
            </p>
          </motion.div>
        )}
      </div>
